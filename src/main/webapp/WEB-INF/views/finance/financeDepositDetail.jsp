		            ...
		            <div class="row ">
		                <div class="col-lg-7">
		                    <div class="d-flex flex-column">
		                        ...
		                        <div class="row">
		                            <div class="col-9">
		                            	<input type="hidden" value="${fixDeposit.id}">
		                                <h2 class="mb-2 mice">
		                                	<c:out value="${fixDeposit.finPrdtNm}"/>
		                                </h2>
		                                <p class="mb-2 pb-1 fs-lg"> &nbsp; - 가입대상 : <c:out value="${fixDeposit.joinMember}"/><br> &nbsp; - 가입방법 : <c:out value="${fixDeposit.joinWay}"/><br> &nbsp; - 최고한도 : <c:out value=" ${fixDeposit.maxLimit}"/></p>
		                            </div>
		                            <div class="col-3">
		                    ...
		                    <div class="ps-lg-5">
		                        <div class="row">
		                            <div class="col-8">
		                                ...
		                                <c:forEach var="depositOption" items="${fixDeposit.fixOptionList}" begin="0" end="0" step="1">
			                                <h3 class="mice mb-2 pb-2">최저 ${depositOption.intrRate} ~ 최고 ${depositOption.intrRate2}</h3>		                                
		                                </c:forEach>
		                            </div>
		                            <div class="col-4">
		                        ...
		                        <div class="card border-0 bg-light mb-4">
		                            <div class="card-body">
		                                ...
		                                <c:set var="spcl" value="${fixDeposit.spclCnd}"></c:set>
		                                <span>${fn:replace(spcl, '-', '<br>-')}</span>
		                            </div>
		                        </div>
		                        <form action="${path}/mypage/finProLikeDe" method="post">
		                        	<input type="hidden" name="finType" value="${fixDeposit.finType}">
		                        	<input type="hidden" name="prtId" value="${fixDeposit.id}">		                        	
		                        ...
		                        <div class="card border-0 bg-light mb-4">
		                            <div class="card-body">
		                                ...
		                                <c:set var="rate" value="${fixDeposit.mtrtInt}"/>
		                        ...
		                        <div class="card border-0 bg-light mb-4">
		                            <div class="card-body">
		                                <h5>Others</h5>
		                                <c:forEach var="depositOption" items="${fixDeposit.fixOptionList}" begin="0" end="0" step="1">			                                		                                
			                                <span>- 금리유형 : ${depositOption.intrRateTypeNm}</span><br>
			                                <span>- 저축기간 : ${depositOption.saveTrm}개월</span><br>
			                                <span>- 최고우대금리 : ${depositOption.intrRate2}%</span><br>
		                                </c:forEach>
		                                <c:set var="etc" value="${fixDeposit.etcNote}"></c:set>
