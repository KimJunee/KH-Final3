                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h2> <a class="text-danger">KOSDAQ</a> 종합지수</h2><br>
                                    ...
                                    <div class="col-md-6 col-xxl-12">
                                        <div class="card" style="height:540px">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                <h4 class="mice"> 인기 <a class="text-danger">KOSDAQ</a> 종목</h4>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xxl-3">
                                <div class="card" style="height:410px">
									...
									<c:if test="${empty list2}">
					                  		<p class="font-18 mb-1">조회된 코스닥지수가 없습니다.</p>				                  	
					                </c:if>
					                <c:if test="${!empty list2}">
					                	<c:forEach var="indexPrice" items="${list2}"  begin="0" end="0" step="1" varStatus="status">
                                    <div class="card-body pt-0">
                                            ...
                                            <div class="tab-pane show active" id="small-table-preview">
                                                <div class="table-responsive-sm">
                                                    <table class="table table-sm table-centered mb-0">
                                                        ...
                                                        <c:if test="${empty list2}">
					                                      	<tr>
					                                      		<td colspan="6">조회된 코스닥지수가 없습니다.</td>
					                                      	</tr>
					                                    </c:if>
					                                    <c:if test="${!empty list2}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card" style="height:990px;">
                                    <div class="card-body">
                                        <h3 class="mice"> <a class="text-danger">KOSDAQ</a> 상위(시가총액기준)</h3>
