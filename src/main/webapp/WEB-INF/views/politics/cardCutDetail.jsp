...
<main>
    <!-- 기사 title -->
    <section class="pb-3 pb-lg-5 mt-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="order-lg-1 order-2">
                        <div class="tns-carousel-wrapper">
                            ...
                            <div class="tns-carousel-inner" data-carousel-options="{&quot;navAsThumbnails&quot;: true, &quot;navContainer&quot;: &quot;#thumbnails&quot;, &quot;gutter&quot;: 12, &quot;responsive&quot;: {&quot;0&quot;:{&quot;controls&quot;: false},&quot;500&quot;:{&quot;controls&quot;: true}}}">
                                <div><img class="rounded-3" src="resources/resources1b/images/04_politics/01_cardcut/09.jpg" alt="Image"></div>
                                <div><img class="rounded-3" src="resources/resources1b/images/04_politics/01_cardcut/09.jpg" alt="Image"></div>
                                <div><img class="rounded-3" src="resources/resources1b/images/04_politics/01_cardcut/10.jpg" alt="Image"></div>
                                <div><img class="rounded-3" src="resources/resources1b/images/04_politics/01_cardcut/11.jpg" alt="Image"></div>
                                <div><img class="rounded-3" src="resources/resources1b/images/04_politics/01_cardcut/12.jpg" alt="Image"></div>
                            </div>
                        </div>
                        <!-- Thumbnails image-->
                        <ul class="tns-thumbnails mb-4" id="thumbnails">
                            <li class="tns-thumbnail"><img src="resources/resources1b/images/04_politics/01_cardcut/09.jpg" alt="Thumbnail"></li>
                            <li class="tns-thumbnail"><img src="resources/resources1b/images/04_politics/01_cardcut/09.jpg" alt="Thumbnail"></li>
                            <li class="tns-thumbnail"><img src="resources/resources1b/images/04_politics/01_cardcut/10.jpg" alt="Thumbnail"></li>
                            <li class="tns-thumbnail"><img src="resources/resources1b/images/04_politics/01_cardcut/11.jpg" alt="Thumbnail"></li>
                            <li class="tns-thumbnail"><img src="resources/resources1b/images/04_politics/01_cardcut/12.jpg" alt="Thumbnail"></li>
                        </ul>
                    </div>
