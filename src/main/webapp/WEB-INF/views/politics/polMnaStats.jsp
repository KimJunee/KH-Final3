                ...
                <div class="row">
                    ...
                    <ul class="nav nav-tabs nav-tabs-dark">
                          <li class="nav-item">
                            ...
                            <li class="nav-item "> <a class="nav-link " href="${path}/politics/polMnaProfileEmpty"> 의원상세보기 </a>
                            </li>
                            <li class="nav-item "> <a class="nav-link active" href="${path}/politics/polMnaStats"> 의원통계보기 </a>
                            </li>
                    </ul>
