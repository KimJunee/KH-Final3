...
<c:if test="${!empty aptLtto}">
                    ...
                    <div class="card-body p-3">
                        <table class="table text-sm mb-0 ">
                            ...
                            <tr>
                                ...
                                <td class="p-3 h5 text-center">${aptLtto.house_secd_nm}</td>
                            </tr>
                            <tr>
                                <th class="p-3 h5 text-center pb-4" style="border-bottom: none">문의처</th>
                                <td class="p-3 h5 text-center pb-4" style="border-bottom: none">
                            ...
                            <div class="card border-0 shadow mb-5 ">
								...
								<div class="card-body  pb-5">
									<table class="table mb-0 m-2">
										...
										<tr>
											<th class="ps-2 ">입주예정년월</th>
											<td class="pe-2 ">${aptLtto.mvn_prearnge_ym}</td>
										</tr>
										<tr>
                                ...
                                <div class="card-body  pb-5">
                                    <table class="table mb-0 m-2">
                                        ...
                                        <tr>
                                            ...
                                            <c:if test="${aptLtto.hmpg_adres == 'null'}">
												<td class="ps-2 p-1">
													<i class="bi bi-house-door-fill me-2 fw-bold "></i>-</td>
											</c:if>
											<c:if test="${aptLtto.hmpg_adres ne 'null'}">
												<td class="ps-2 p-1"><a href="${aptLtto.hmpg_adres}"
													class="badge bg-secondary bg-opacity-75 text-white mb-2">
													<i class="bi bi-house-door-fill me-2 fw-bold "></i>${aptLtto.hmpg_adres}</a></td>
											</c:if>
	...
	<script>
		...
		// 주소로 좌표를 검색합니다
		geocoder.addressSearch('${aptLtto.hssply_adres}',
