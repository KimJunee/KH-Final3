...
<body>
                    ...
                    <figure class="position-absolute top-0 start-100 translate-middle pe-5 pb-4">
                        <svg width="94.5px" height="67.6px" viewBox="0 0 94.5 67.6">
                            <path class="fill-purple" d="M15.1,3.4c-0.3,0.4-0.4,1-0.1,1.5l2,3.2l-1.3,1.7c-1-0.2-1.9,0.2-2.5,1c-0.5,0.7-0.6,1.6-0.3,2.4l-9.2,9.5
                                ...
                                C57.5,58.1,60.8,63.5,59.8,64.9z"></path>
                            </svg>
                    </figure>
                    <p>청약에 관한 상세 정보, 청약 일정, 공지사항 등의 전반적인 내용을 확인하실 수 있습니다.</p>
                    <!-- Buttons -->
            ...
            <div class="row g-5 ">
                        ...
                        <div class="card-body p-3 ">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center ">
                                    <a href="#" class="badge text-bg-danger mb-2"><i class="fas small fw-bold"></i>공지</a>
                                    <div class="ms-3 ">
                                        <a href="# " class="h6 stretched-link ">[확인필수] 2022년 소규모주택정비 관리지역 후보지 공모</a>
                            ...
                            <div class="col-12 ">
                                <div class="d-flex align-items-center">
                                    <a href="#" class="badge text-bg-primary mb-2"><i class="fas small fw-bold"></i>보도</a>
                                    <div class="ms-3 ">
                                        <a href="# " class="h6 stretched-link ">2022년 부동산개발 전문인력 대상 연수교육 수강생 모집</a>
                                        <p class="small mb-0 ">2022. 09. 26</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-7 ">
                    ...
                    <div class="card border h-md-600">
                        ...
                        <!-- 청약지도 body -->
                        <div class="card-body">
                            <div id="row content" class="mt-2">
                                <div id="info-box"></div>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:amcharts="http://amcharts.com/ammap" xmlns:xlink="http://www.w3.org/2000/svg" version="1.1" width="500" height="570" viewBox="-110 340 550 300"> 
                                <defs>
                                    <style type="text/css">
                                        .land
                                        {
                            ...
                            <div class="row ">
                                ...
                                <div class="col-12 ">
                                    <div class="d-flex align-items-center position-relative ">
                                        <div class="ms-3 ">
                                            <a href="# " class="h6 stretched-link ">시흥시 매입임대주택 입주자 선착순 수시모집</a>
                                            <p class="small mb-0 ">청약 접수 : 2022. 09. 26 &nbsp; &nbsp; &nbsp; 청약 마감 : 2022. 10. 06</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- 구분선 -->
                                ...
                                <div class="col-12 ">
                                    <div class="d-flex align-items-center position-relative ">
                                        <div class="ms-3 ">
                                            <a href="# " class="h6 stretched-link ">김포마송 B-5블록 행복주택 입주자격완화 추가 모집</a>
                                            <p class="small mb-0 ">청약 접수 : 2022. 09. 26 &nbsp; &nbsp; &nbsp; 청약 마감 : 2022. 10. 06</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 ">
                                    <div class="d-flex align-items-center position-relative ">
                                        <div class="ms-3 ">
                                            <a href="# " class="h6 stretched-link ">경기 수원시 집주인 임대주택 선착순 수시모집</a>
                                            <p class="small mb-0 ">청약 접수 : 2022. 09. 26 &nbsp; &nbsp; &nbsp; 청약 마감 : 2022. 10. 06</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 ">
                                    <div class="d-flex align-items-center position-relative ">
                                        <div class="ms-3 ">
                                            <a href="# " class="h6 stretched-link ">화성비봉 A-3블록 공공분양주택 입주자 모집</a>
                                            <p class="small mb-0 ">청약 접수 : 2022. 09. 26 &nbsp; &nbsp; &nbsp; 청약 마감 : 2022. 10. 06</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table align-middle p-4 mb-0 table-hover table-shrink m-auto">
                                    ...
                                    <tbody class="border-top-0 text-center">
                                        ...
                                        <tr>
                                            ...
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0 "><a href="# ">창동 다우아트리체 주상복합 아파트</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>2023-05-23</td>
                                            <!-- Table data -->
                                        ...
                                        <tr>
                                            ...
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0 "><a href="# ">힐스테이트 청량리 메트로블 (도시형생활주택)</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>2023-05-23</td>
                                            <!-- Table data -->
                                        ...
                                        <tr>
                                            ...
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0 "><a href="# ">평택화양 휴먼빌 퍼스트시티</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>2023-05-23</td>
                                            <!-- Table data -->
    ...
    <!-- Vendors -->
    <script src="resources/resources1b/vendor/tiny-slider/tiny-slider.js"></script>
    <script src="resources/resources1b/vendor/sticky-js/sticky.min.js"></script>
    <script src="resources/resources1b/vendor/glightbox/js/glightbox.js"></script>
    <script src="resources/resources1b/vendor/plyr/plyr.js"></script>
    ...
    <script>
        ...
        var total = 0; //지역별 청약수
        document.getElementById("date").innerHTML = '오늘: ' + todayDate;

        for (var k in confirmed) {
            total += confirmed[k];
        }
        document.getElementById("countryList").innerHTML = '<b>전국</b><br /></b>청약:<b>' + total;
        for (var k in confirmed) {
