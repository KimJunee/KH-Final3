                    ...
                    <div class="card-body p-3">
                        <table class="table text-sm mb-0 ">
                            ...
                            <tr>
                                ...
                                <td class="p-3 h5 text-center">${urbty.house_secd_nm}</td>
                            </tr>
                            <tr>
								...
								<div class="card-body  pb-5">
									<table class="table mb-0 m-2">
										...
										<tr>
											...
											<td class="pe-2 ">${urbty.mvn_prearnge_ym}</td>
										</tr>
										<tr>
                                ...
                                <div class="card-body  pb-5">
                                    <table class="table mb-0 m-2">
                                        ...
                                        <tr>
                                            ...
                                            <c:if test="${urbty.hmpg_adres == 'null'}">
												<td class="ps-2 p-1">
													<i class="bi bi-house-door-fill me-2 fw-bold "></i>-</td>
											</c:if>
											<c:if test="${urbty.hmpg_adres ne 'null'}">
												<td class="ps-2 p-1"><a href="${urbty.hmpg_adres}"
													class="badge bg-secondary bg-opacity-75 text-white mb-2">
													<i class="bi bi-house-door-fill me-2 fw-bold "></i>${urbty.hmpg_adres}</a></td>
											</c:if>
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:150px;text-align:center;padding:6px 0;">${urbty.house_nm}</div>'
										});
