...
<head>
	...
	<link href="http://fonts.googleapis.com/css2?family=Nunito+Sans:wght@400;700&family=Rubik:wght@400;500;700&display=swap" rel="stylesheet">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasMenu">
	...
	<div class="offcanvas-body d-flex flex-column pt-0">
		<div>
			<img class="light-mode-item my-3" src="resources/images/logo.svg" alt="logo">
			<img class="dark-mode-item my-3" src="resources/images/logo-light.svg" alt="logo">
...
<section class="pt-4 pb-0 card-grid">
	<div class="container">
		<div class="row g-4">
			<!-- Left big card -->
			<div class="col-lg-6">
				<div class="card card-overlay-bottom card-grid-lg card-bg-scale" style="background-image:url(resources/images/blog/1by1/01.jpg); background-position: center left; background-size: cover;">
					<!-- Card featured -->
									...
									<div class="nav-link">
										<div class="d-flex align-items-center text-white position-relative">
											<div class="avatar avatar-sm">
												<img class="avatar-img rounded-circle" src="resources/images/avatar/11.jpg" alt="avatar">
											</div>
			...
			<div class="col-lg-6">
				<div class="row g-4">
					<!-- Card item START -->
					<div class="col-12">
						<div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url(resources/images/blog/1by1/02.jpg); background-position: center left; background-size: cover;">
							<!-- Card Image -->
							<!-- Card Image overlay -->
							<div class="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
								<div class="w-100 mt-auto">
					...
					<!-- Card item START -->
					<div class="col-md-6">
						<div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url(resources/images/blog/1by1/03.jpg); background-position: center left; background-size: cover;">
							<!-- Card Image overlay -->
							<div class="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
								<div class="w-100 mt-auto">
									<!-- Card category -->
    ...
    <footer class="bg-dark pt-3 ">
        <div class="container ">
            ...
            <div class="row pt-3 pb-1 ">
                <div class="col-md-3 ">
                    <img src="assets/images/1fintouch/logo_white.png" alt="footer logo ">
                </div>
                <div class="col-md-5 ">
