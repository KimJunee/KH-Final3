              ...
              <img class="navbar-brand-item dark-mode-item " src="${path}/resources/resources1b/images/01_main/logo_dark.png" alt="logo ">
                ...
                <div class="collapse navbar-collapse  " id="navbarCollapse ">
                    <ul class="navbar-nav navbar-nav-scroll mx-auto ">
                        ...
                        <!-- 부동산청약 메뉴 시작 -->
                        <li class="nav-item dropdown ">
                            <a class="nav-link-white-sp" href="${path}/RealEstate/main" id="postMenu " data-bs-toggle="dropdown " aria-haspopup="true " aria-expanded="false ">부동산청약</a>
                            <ul class="dropdown-menu text-dark" aria-labelledby="postMenu ">
                                <!-- dropdown submenu -->
                                <li class="dropdown-submenu dropend text-dark">
                        ...
                        <!-- 정치 메뉴 시작-->
                        <li class="nav-item dropdown ">
                            <a class="nav-link-white-sp" href="${path}/politics/cardCut" id="pagesMenu " data-bs-toggle="dropdown " aria-haspopup="true " aria-expanded="false ">정치</a>
                            <ul class="dropdown-menu " aria-labelledby="pagesMenu ">
                                <!-- dropdown submenu -->
                                <li class="dropdown-submenu dropend text-dark">
                                    <a class="dropdown-item text-dark" href="${path}/politics/cardCut">카드한컷 <span class="badge bg-danger smaller me-1">New</span></a>
                                </li>
                                <li> <a class="dropdown-item text-dark" href="${path}/politics/cardCut">정부부처소개</a> </li>
                                <li> <a class="dropdown-item text-dark" href="${path}/politics/polMnaList">제21대 국회의원현황</a> </li>
                        ...
                        <!-- 뉴스 메뉴 시작 -->
                        <li class="nav-item "> <a class="nav-link-white-sp" href="${path}/news/main">뉴스</a></li>
                        <!-- 뉴스 메뉴 끝  -->

                        <!-- 오피니언 메뉴 시작 -->
                        <li class="nav-item "> <a class="nav-link-white-sp" href="${path}/opinion">오피니언</a></li>
                        <!-- 오피니언 메뉴 끝 -->

                        <!-- 커뮤니티 메뉴 시작 -->
                        <li class="nav-item dropdown">
                            <a class="nav-link-white-sp" href="${path}/board/communityMain" id="postMenu " data-bs-toggle="dropdown " aria-haspopup="true " aria-expanded="false ">커뮤니티</a>
                            <ul class="dropdown-menu text-dark" aria-labelledby="postMenu ">
                                <!-- dropdown submenu -->
                                <li class="dropdown-submenu dropend text-dark">
                                    <a class="dropdown-item text-dark" href="${path}/board/communityMain">커뮤니티메인</a></li>
                                <li class="dropdown-submenu dropend text-dark">
