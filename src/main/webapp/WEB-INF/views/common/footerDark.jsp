        ...
        <div class="container ">
            ...
            <div class="row pt-1 ">
                ...
                <div class="col-sm-6 col-lg-3 mb-3 ">
                    ...
                    <ul class="nav flex-column text-primary-hover ">
                        <li class="nav-item "><a class="nav-link pt-0 " ><i class="fab fa-whatsapp fa-fw me-2 "></i>WhatsApp</a></li>
...
JS libraries, plugins and custom scripts -->
    ...
    <!-- Vendors -->
    <script src="${path}/resources/resources1b/vendor/tiny-slider/tiny-slider.js "></script>
    <script src="${path}/resources/resources1b/vendor/sticky-js/sticky.min.js "></script>
    <script src="${path}/resources/resources1b/vendor/glightbox/js/glightbox.js "></script>
    <script src="${path}/resources/resources1b/vendor/plyr/plyr.js "></script>
    ...
    <script src="${path}/resources/resources1b/js/demo.apex-area.js "></script>
    <script src="${path}/resources/resources1b/js/demo.apex-area2.js "></script>
    <script src="${path}/resources/resources1b/js/demo.apex-area3.js "></script>
