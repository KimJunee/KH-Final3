        ...
        <nav class="navbar navbar-expand-sm navbar-nav-sp nav-link-sp">
            <div class="container ">
                ...
                <a class="navbar-brand navbar-nav-sp nav-link-sp" href="01_main.html" style="margin-top:-5px">
                    <img class="navbar-brand-item light-mode-item " src="assets/images/01_main/logo_white.png" alt="logo ">
                    <img class="navbar-brand-item dark-mode-item " src="assets/images/01_main/logo_white.png" alt="logo ">
                </a>
                <!-- 로고 끝-->
                <!-- 메뉴 시작 -->
                    ...
                    <ul class="navbar-nav navbar-nav-scroll mx-auto ">
                        ...
                        <li class="nav-item dropdown ">
                            ...
                            <ul class="dropdown-menu bg-dark" aria-labelledby="pagesMenu ">
                                ...
                                <li class="dropdown-divider text-white"></li>
                                <li> <a class="dropdown-item text-white" href="07_com_politics.html">정치Talk <span class="badge bg-danger smaller me-1">New</span></a> </li>
                            </ul>
                        </li>
                        <!-- 정치 메뉴 끝-->
                        ...
                        <!-- 커뮤니티 메뉴 시작 -->
                        <li class="nav-item dropdown">
                            <a class="nav-link-sp " href="07_com_main.html" id="postMenu " data-bs-toggle="dropdown " aria-haspopup="true " aria-expanded="false ">커뮤니티</a>
                            <ul class="dropdown-menu bg-dark text-white" aria-labelledby="postMenu ">
                                <!-- dropdown submenu -->
                                <li class="dropdown-submenu dropend text-white">
