...
$.ajax({
    ...
    success: function(map) {
        ...
        this.dayBalanceData = [];
        for (t = 0; t < 100; t++) {
            this.dayBalanceData.push(new Date(dateList[t]), valueList[t])
        }
...
! function(a) {
    ...
    function t() {}
    t.prototype.generateData = function() { for (var t = [], e = 0; e < 100; e++) t.push(5e3 + 1e5 * Math.random() + .8 * e * e * e); return t }, t.prototype.init = function() {
