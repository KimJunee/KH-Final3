! function(a) { "use strict";
    ...
    t.prototype.generateData = function() { for (var t = [], e = 0; e < 100; e++) t.push(5e3 + 1e5 * Math.random() + .8 * e * e * e); return t }, t.prototype.init = function() { this.dayDummyData = this.generateData(), this.monthDummyData = this.generateData(), this.weekDummyData = this.generateData(), this.yearDummyData = this.generateData(), this.dayBalanceData = []; for (var t = 0; t < 100; t++) { var e = new Date;
        ...
        this.initCurrencyBTC(), this.initCurrencyCNY(), this.initCurrencyETH(), this.initDayBalance(), this.initWeekBalance(), this.initMonthBalance(), this.initYearBalance() }, t.prototype.initCurrencyBTC = function() { var t = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"],
        ...
        new ApexCharts(document.querySelector("#currency-btc-chart"), e).render() }, t.prototype.initCurrencyCNY = function() { var t = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"],
        ...
        new ApexCharts(document.querySelector("#currency-cny-chart"), e).render() }, t.prototype.initCurrencyETH = function() { var t = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"],
