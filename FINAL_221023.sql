...
*/
/* 오류뜨는 오피니언 지우기
DELETE FROM OPINION WHERE OPINIONNO = 15;
DELETE FROM OPINION WHERE OPINIONNO = 50;
DELETE FROM OPINION WHERE OPINIONNO = 35;
DELETE FROM OPINION WHERE OPINIONNO = 34;
DELETE FROM OPINION WHERE OPINIONNO = 30;
DELETE FROM OPINION WHERE OPINIONNO = 29;
DELETE FROM OPINION WHERE OPINIONNO = 21;
DELETE FROM OPINION WHERE OPINIONNO = 16;
DELETE FROM OPINION WHERE OPINIONNO = 10;
