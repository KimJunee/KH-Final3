...
-- 청약 - APT분양정보 상세 및 APT 분양정보 주택형별 상세 DB INSERT (이미향)
...
CREATE TABLE USER_T(
	...
	USER_PASSWORD VARCHAR2(50),     -- 비밀번호
...
-- INSERT INTO USER_T VALUES(SEQ_USER_NO.NEXTVAL, 'test01', '건물주가될테야', 'qlalf12', 'test01@gmail.com');
...
CREATE TABLE BOARD (
	...
	BOARD_FILE	VARCHAR2(1000)      -- 첨부파일
);
COMMENT ON TABLE BOARD IS '게시판';
COMMENT ON COLUMN  BOARD.BOARD_NO IS '게시글번호';
COMMENT ON COLUMN  BOARD.USER_NO IS '사용자번호';
...
-- INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL, 1, 1, 10, '야호', '이야호오 신난다아아아ㅏ앙', SYSDATE, 'img01.jpg');
...
COMMENT ON COLUMN  REPLY.USER_NO IS '사용자번호';
